...
function (_React$PureComponent) {
  function Field() {
    ...
    _this.constructComponent = function (bindingProps, triggerMeta) {
      ...
      var fieldProps = omit(_this.props, Object.keys(Field.propTypes));
      fieldProps = _extends({
        name: name
      ...
      if (process.env.NODE_ENV !== 'production') !(formContext.noValidate || !name || schema) ? process.env.NODE_ENV !== "production" ? invariant(false, "There is no corresponding schema defined for this field: \"" + name + "\" " + "Each Field's `name` prop must be a valid path defined by the parent Form schema") : invariant(false) : void 0;

      var _ref = !noResolveType ? resolveFieldComponent(type, schema) : [null, type],
          Component = _ref[0],
          resolvedType = _ref[1];
      ...
      return React.createElement(Component, _extends({}, fieldProps, {
        __source: {
  ...
  _proto.createEventHandlers = function createEventHandlers(_ref2) {
    ...
    var _ref2$events = _ref2.events,
        events = _ref2$events === void 0 ? config.events : _ref2$events;
  ...
  _proto.render = function render() {
    ...
    return React.createElement(Consumer, {
      ...
      var _this3$props = _this3.props,
          ...
          events = _this3$props$events === void 0 ? config.events : _this3$props$events;
      ...
      return React.createElement(Binding, {
        ...
        return React.createElement(FormTrigger, {
          "for": name,
          group: group,
          events: events,
          triggers: triggers,
